<template>
	<view class="you-scroll" ref="youScroll">
		<view class="pullDown" :style="{ transform: 'translateY('+translateY+'px)', transition: isDown ? '0s' : '0.3s' }">
			<slot name="pullDown">
				<img src="../static/images/loading01.gif" :class="{'down-icon': true,'animate': pullDownStatus == 3}"></img>
				<!-- <view v-if="refreshs" style="background: red;width: 100%;height: 50rpx;">刷新成功</view> -->
			</slot>
		</view>
